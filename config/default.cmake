...
elseif(${BUILD_TYPE} STREQUAL "GPU" ) # Compiler for gpu acceleration 
  ...
  set(CMAKE_Fortran_FLAGS "-acc=verystrict,gpu -target=gpu -Minfo=accel,inline -gpu=ccnative,lineinfo -Mfree  -cpp") 
  #set(USER_Fortran_FLAGS "-cpp -ffree-form -ffree-line-length-none -fno-automatic")
  #set(CMAKE_Fortran_FLAGS "-acc=gpu -target=gpu -Minfo=accel,inline -gpu=lineinfo,cc80 -cpp")
  add_definitions(-D_DEBUG_GPU) 
  set(CMKAE_BUILD_TYPE DEBUG_GPU) 
